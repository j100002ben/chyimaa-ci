...
class MY_Encrypt extends CI_Encrypt {
	...
	public function phash($password, $obscured = NULL, $algorithm = 'sha1'){
	...
	protected function _scramble($hash, $salt, $password){
    ...
    protected function _harvest($obscured, $slen, $password){
